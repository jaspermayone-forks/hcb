...
2) Install [RIOT](https://github.com/redis/riot) locally (or anywhere you like to work!).
3) Turn on maintenance mode and disable Sidekiq - this is to prevent new jobs from being added to the queue.
